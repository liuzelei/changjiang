...
var Layout = function () {
  ...
  var handleStickyActionButtons = function () {
    if ($(".form-actions:visible:not(.unsticky)").length != 0){
      $(".form-actions:visible:not(.unsticky)").css("position", "static");
      ...
      $(".form-actions:visible:not(.unsticky)").css("z-index", 10000)
                        .css("position", "relative")
                        .css("top", $(window).scrollTop() + offset_init);

      $(window).scroll(function(){
        $(".form-actions:visible:not(.unsticky)").css("top", $(window).scrollTop() + offset_init);
      });
    }
  }
